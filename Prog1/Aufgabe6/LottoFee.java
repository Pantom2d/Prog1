...
public class LottoFee {
    ...
    public static void main(String[] args) {
        LottoFee ziehung1 = new LottoFee();
        LottoFee ziehung2 = new LottoFee();
        for(int i = 0; i < 7; i++){
            System.out.println("Zahl " + i + " :" + ziehung1.nextNumber());
        }
        for(int i = 0; i < 7; i++){
            System.out.println("Zahl " + i + " :" + ziehung2.nextNumber());
        }
    }
